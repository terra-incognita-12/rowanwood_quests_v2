...
import { createLibraryRecord } from "../../../api/libraryApi";
import { redirectTo } from "../../../utils/navigations";

const PHOTO_REGEX = /\.(jpg|jpeg)$/

/* 
Editor section, create new library record
*/
const CreateLibraryRecord = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoading(true);
            setError(null);
            const response = await createLibraryRecord(formDataToSend);
    ...
    return (
        <Box>
            <Box sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Typography variant="h3">New Library Record</Typography>
            </Box>
